...
- **커뮤니케이터 역할**: 외부 프로젝트 에이전트와의 접창구 역할을 수행하며, [COMMUNICATION_GUIDE.md](docs/COMMUNICATION_GUIDE.md)에 따라 요청을 문서화하고 관리한다.
- 결정 사항은 체크리스트나 docs에 기록해 팀이 추적할 수 있도록 한다.

## Reference Docs

- [COMMUNICATION_GUIDE.md](docs/COMMUNICATION_GUIDE.md): 외부 에이전트 협업 가이드.
- [EXTERNAL_REQUESTS.md](docs/EXTERNAL_REQUESTS.md): 외부 요청 기록 로그.
